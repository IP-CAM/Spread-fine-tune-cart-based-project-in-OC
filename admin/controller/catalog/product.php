...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['products'][] = array(
				...
				'is_printable'     => ($result['is_printable'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
				//  changed by braj singh end here<div></div>
	...
	protected function getForm() {
		...
		//  changed by braj singh start here
		$this->data['entry_is_printable'] = $this->language->get('entry_is_printable');
		...
		//  changed by braj singh start here
		$this->data['tab_pricing'] = $this->language->get('tab_pricing');
		//  changed by braj singh end here
		...
		//  changed by braj singh start here
		if (isset($this->request->post['is_printable'])) {
			$this->data['is_printable'] = $this->request->post['is_printable'];
		} elseif (!empty($product_info)) {
			$this->data['is_printable'] = $product_info['is_printable'];
		} else {
			$this->data['is_printable'] = 1;
		}
		//  changed by braj singh end here
		...
		//  changed by braj singh start here
		$results = $this->model_catalog_product->getProductViewOptions();
		$this->data['view_options'] = array();
		...
		foreach ($product_images as $product_image) {
			...
			$this->data['product_images'][] = array(
				...
				'views_id' => $product_image['views_id']
			);
		}
