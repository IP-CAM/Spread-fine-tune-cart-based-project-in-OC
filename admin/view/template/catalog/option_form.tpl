            ...
            <tr>
              ...
              <td class="left"><input type="hidden" name="option_value[<?php echo $option_value_row; ?>][option_value_id]" value="<?php echo $option_value['option_value_id']; ?>" />
                ...
                foreach ($languages as $language) { 
                  if(isset($option_value['option_value_description'][$language['language_id']]))
                  {
                    $we =  $option_value['option_value_description'][$language['language_id']]['name'];
                    $we_color = strrchr($we, "#");
                    $we_name = str_replace($we_color, '', $we);
                  }
                  ?>

                <input type="text" name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['language_id']; ?>][name]" value="<?php echo $we_name; ?>" />
                ...
                <?php } if($_GET['option_id']==14){ ?>
                <input type="Color" name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['language_id']; ?>][color]" value="<?php echo $we_color; ?>" />
                <?php } ?></td>
                 <?php //  changed by braj singh end here?>
...
//  changed by braj singh start here
    <?php } if($_GET['option_id']==14){?>
     html +=  '<input type="color" name="option_value[<?php echo $option_value_row; ?>][option_value_description][<?php echo $language['language_id']; ?>][color]" />';
      <?php }?>
  html += '    </td>';
