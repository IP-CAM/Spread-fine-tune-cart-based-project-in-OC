...
class ModelSaleOrder extends Model {
	...
	public function OrderProductPdf($product_id,$order_id) {
				
		$query = $this->db->query("SELECT zipname FROM `" . DB_PREFIX . "order_product_pdf` WHERE product_id='" . $product_id . "' AND order_id='".$order_id."'");	
		
		$result=$query->row;
		$zipname=(!empty($result['zipname']))?$result['zipname']:'';
		return $zipname;
	}	
	public function OrderProductImage($product_id) {
