...
$sqlurl = "SELECT user_type FROM ". DB_PREFIX ."main_product where product_id='".$product_id."'";
	...
	$httpurl=HTTP_SERVER.'share-image.php?productId='.$productId;	
		   }else{
...
<head>
	...
	<meta name="title" content="Check out my Design, you can do yours @ www.bluzty.com" />
...
<body>
	...
	<img src="<?php echo HTTP_SERVER.'image/'.$row->image;?>" width="41" height="41"  border="0" alt=""/>
	</p>
</body>
</html>
