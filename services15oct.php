...
exec(IMAGEMAGICPATH." -density 300 -channel RGBA -colorspace RGB -background none -fill none -dither None $dest $pngDestPath");	//	Convert .AI File Into .PNG FILE
...
exec(IMAGEMAGICPATH." $pngDestPath -resize 45x45 $thumbPath");	//	Make Thumbnail Of Image
