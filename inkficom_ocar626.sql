...
--
-- Host: localhost
-- Generation Time: Oct 06, 2014 at 06:10 AM
...
--
-- Table structure for table `oc_color`
--

CREATE TABLE IF NOT EXISTS `oc_color` (
...
--
-- Dumping data for table `oc_color`
--

INSERT INTO `oc_color` (`color_id`, `name`, `code`, `is_default`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `oc_color_option`
--

CREATE TABLE IF NOT EXISTS `oc_color_option` (
  `color_id` int(11) NOT NULL,
  `option_value_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `oc_color_option`
--

INSERT INTO `oc_color_option` (`color_id`, `option_value_id`) VALUES
(1, 78),
(2, 65),
(3, 74),
(4, 67),
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.61320001, 1, '2014-09-26 04:03:36'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2014-09-26 10:04:06'),
(3, 'Euro', 'EUR', '', '€', '2', 0.78450000, 1, '2014-09-26 04:03:36');
...
INSERT INTO `oc_design` (`id`, `price`, `image`, `colorable`, `designArray`, `status`, `keyword`, `cat_id`, `sub_cat_id`, `toolarr`) VALUES
...
--
-- Table structure for table `oc_design_category`
--

CREATE TABLE IF NOT EXISTS `oc_design_category` (
  `category_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) DEFAULT NULL,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `top` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `oc_design_category`
--

INSERT INTO `oc_design_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
(1, '', 0, 1, 1, 0, 1, '2013-09-18 07:03:51', '2013-09-18 08:12:12');

-- --------------------------------------------------------

--
-- Table structure for table `oc_design_category_description`
--

CREATE TABLE IF NOT EXISTS `oc_design_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `oc_design_category_description`
--

INSERT INTO `oc_design_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
(1, 1, 'Logos', '&lt;p&gt;Logos&lt;/p&gt;\r\n', 'Logos', 'Logos');

-- --------------------------------------------------------

--
-- Table structure for table `oc_design_category_filter`
--

CREATE TABLE IF NOT EXISTS `oc_design_category_filter` (
  `category_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`filter_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `oc_design_category_path`
--

CREATE TABLE IF NOT EXISTS `oc_design_category_path` (
  `category_id` int(11) NOT NULL,
  `path_id` int(11) NOT NULL,
  `level` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`path_id`)
...
--
-- Dumping data for table `oc_design_category_path`
--

INSERT INTO `oc_design_category_path` (`category_id`, `path_id`, `level`) VALUES
(1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `oc_design_category_to_layout`
--

CREATE TABLE IF NOT EXISTS `oc_design_category_to_layout` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
...
--
-- Table structure for table `oc_design_category_to_store`
--

CREATE TABLE IF NOT EXISTS `oc_design_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `oc_design_category_to_store`
--

INSERT INTO `oc_design_category_to_store` (`category_id`, `store_id`) VALUES
(1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `oc_design_description`
--

CREATE TABLE IF NOT EXISTS `oc_design_description` (
...
--
-- Dumping data for table `oc_design_description`
--

INSERT INTO `oc_design_description` (`id`, `design_id`, `language_id`, `title`, `keywords`, `description`, `detail`) VALUES
...
INSERT INTO `oc_font` (`font_id`, `name`, `image`, `fontSWF`, `directionshow`, `is_default`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `oc_font_value`
--

CREATE TABLE IF NOT EXISTS `oc_font_value` (
...
--
-- Dumping data for table `oc_font_value`
--

INSERT INTO `oc_font_value` (`font_value_id`, `font_id`, `image`, `font_ttf`, `font_type`) VALUES
...
--
-- Table structure for table `oc_main_product`
--

CREATE TABLE IF NOT EXISTS `oc_main_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `oc_order_product_pdf`
--

CREATE TABLE IF NOT EXISTS `oc_order_product_pdf` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_product_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
INSERT INTO `oc_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `date_added`, `date_modified`, `viewed`, `is_printable`) VALUES
(28, 'Product 1', '', '', '', '', '', '', '', 939, 7, 'data/demo/htc_touch_hd_1.jpg', 5, 1, '100.0000', 200, 9, '2009-02-03', '146.40000000', 2, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 16:06:50', '2011-09-30 01:05:39', 0, 0),
(29, 'Product 2', '', '', '', '', '', '', '', 999, 6, 'data/demo/palm_treo_pro_1.jpg', 6, 1, '279.9900', 0, 9, '2009-02-03', '133.00000000', 2, '0.00000000', '0.00000000', '0.00000000', 3, 1, 1, 0, 1, '2009-02-03 16:42:17', '2011-09-30 01:06:08', 0, 0),
(30, 'Product 3', '', '', '', '', '', '', '', 7, 6, 'data/demo/canon_eos_5d_1.jpg', 9, 1, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 16:59:00', '2011-09-30 01:05:23', 0, 0),
(31, 'Product 4', '', '', '', '', '', '', '', 1000, 6, 'data/demo/nikon_d300_1.jpg', 0, 1, '80.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 3, 1, 1, 0, 1, '2009-02-03 17:00:10', '2011-09-30 01:06:00', 1, 0),
(32, 'Product 5', '', '', '', '', '', '', '', 999, 6, 'data/demo/ipod_touch_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 17:07:26', '2011-09-30 01:07:22', 0, 0),
(33, 'Product 6', '', '', '', '', '', '', '', 1000, 6, 'data/demo/samsung_syncmaster_941bw.jpg', 0, 1, '200.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 17:08:31', '2011-09-30 01:06:29', 1, 0),
(34, 'Product 7', '', '', '', '', '', '', '', 1000, 6, 'data/demo/ipod_shuffle_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 18:07:54', '2011-09-30 01:07:17', 0, 0),
(35, 'Product 8', '', '', '', '', '', '', '', 1000, 5, '', 0, 0, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 18:08:31', '2011-09-30 01:06:17', 0, 0),
(36, 'Product 9', '', '', '', '', '', '', '', 994, 6, 'data/demo/ipod_nano_1.jpg', 8, 0, '100.0000', 100, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 18:09:19', '2011-09-30 01:07:12', 0, 0),
(40, 'product 11', '', '', '', '', '', '', '', 970, 5, 'data/demo/iphone_1.jpg', 8, 1, '101.0000', 0, 9, '2009-02-03', '10.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 21:07:12', '2011-09-30 01:06:53', 0, 0),
(41, 'Product 14', '', '', '', '', '', '', '', 977, 5, 'data/demo/imac_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-03', '5.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, '2009-02-03 21:07:26', '2011-09-30 01:06:44', 0, 0),
(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'data/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 9, '2009-02-04', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 2, 0, 1, '2009-02-03 21:07:37', '2014-09-25 02:06:23', 0, 0),
(43, 'Product 16', '', '', '', '', '', '', '', 929, 5, 'data/demo/macbook_1.jpg', 8, 0, '500.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:07:49', '2011-09-30 01:05:46', 0, 0),
(44, 'Product 17', '', '', '', '', '', '', '', 1000, 5, 'data/demo/macbook_air_1.jpg', 8, 1, '1000.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:08:00', '2011-09-30 01:05:53', 0, 0),
(45, 'Product 18', '', '', '', '', '', '', '', 998, 5, 'data/demo/macbook_pro_1.jpg', 8, 1, '2000.0000', 0, 100, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:08:17', '2011-09-15 22:22:01', 0, 0),
(46, 'Product 19', '', '', '', '', '', '', '', 1000, 5, 'data/demo/sony_vaio_1.jpg', 10, 1, '1000.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-03 21:08:29', '2011-09-30 01:06:39', 0, 0),
(47, 'Product 21', '', '', '', '', '', '', '', 1000, 5, 'data/demo/hp_1.jpg', 7, 1, '100.0000', 400, 9, '2009-02-03', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, '2009-02-03 21:08:40', '2011-09-30 01:05:28', 0, 0),
(48, 'product 20', 'test 1', '', '', '', '', '', 'test 2', 995, 5, 'data/demo/ipod_classic_1.jpg', 8, 1, '100.0000', 0, 9, '2009-02-08', '1.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 2, 1, 1, 0, 1, '2009-02-08 17:21:51', '2011-09-30 01:07:06', 0, 0),
(49, 'SAM1', '', '', '', '', '', '', '', 0, 8, 'data/demo/samsung_tab_1.jpg', 0, 1, '199.9900', 0, 9, '2011-04-25', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2011-04-26 08:57:34', '2011-09-30 01:06:23', 3, 0),
(56, '55', '', '', '', '', '', '', '', 1, 5, '', 0, 1, '1.0000', 0, 0, '2014-09-24', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2014-09-25 07:07:53', '0000-00-00 00:00:00', 0, 1),
(55, '56', '', '', '', '', '', '', '', 1, 5, '', 0, 1, '1.0000', 0, 0, '2014-09-24', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2014-09-25 07:02:07', '0000-00-00 00:00:00', 0, 1),
(53, '54', '', '', '', '', '', '', '', 1, 5, '', 0, 1, '1.0000', 0, 0, '2014-09-24', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2014-09-25 05:47:21', '2014-09-25 06:01:13', 0, 1),
(54, '56', '', '', '', '', '', '', '', 1, 5, '', 0, 1, '1.0000', 0, 0, '2014-09-24', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2014-09-25 07:00:52', '0000-00-00 00:00:00', 0, 1),
(57, '45', '', '', '', '', '', '', '', 1, 5, '', 0, 1, '1.0000', 0, 0, '2014-09-24', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2014-09-25 07:33:54', '0000-00-00 00:00:00', 6, 1),
(58, '53', '', '', '', '', '', '', '', 1, 7, '', 0, 1, '1.0000', 0, 0, '2014-09-25', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2014-09-26 05:58:06', '2014-09-26 06:11:22', 1, 1),
(59, '54', '', '', '', '', '', '', '', 1, 5, '', 0, 1, '1.0000', 0, 0, '2014-09-25', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2014-09-26 06:12:51', '2014-09-26 06:13:24', 0, 1);
...
(58, 1, 'TestColor', '&lt;p&gt;TestColor&lt;/p&gt;\r\n', 'TestColor', 'TestColor', ''),
(53, 1, 'testprinting', '', '', '', ''),
(54, 1, 'testprinting2', '', '', '', ''),
(55, 1, 'testprinting2', '', '', '', ''),
(56, 1, 'testprinting2', '', '', '', ''),
(57, 1, 'testprinting45', '', '', '', ''),
(59, 1, 'TestColorSelected', '', '', '', ''),
...
INSERT INTO `oc_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`, `views_id`) VALUES
...
(2361, 42, 'data/demo/canon_eos_5d_2.jpg', 0, 0),
(2360, 42, 'data/demo/canon_logo.jpg', 0, 0),
(2359, 42, 'data/demo/hp_1.jpg', 0, 0),
(2358, 42, 'data/demo/compaq_presario.jpg', 0, 0),
(2357, 42, 'data/demo/canon_eos_5d_1.jpg', 0, 0),
(2362, 54, '', 0, 0),
(2363, 54, '', 0, 0),
(2364, 55, '', 0, 0),
(2365, 55, '', 0, 0),
...
(2367, 56, '', 0, 50),
(2368, 56, '', 0, 52),
(2369, 57, 'data/webroot/product/original/2013072611541413748396541447871363.png', 0, 50),
(2370, 57, 'data/webroot/product/original/2013072611541513748396551847912606.png', 0, 49);
...
CREATE TABLE IF NOT EXISTS `oc_product_option_value` (
  ...
  `default_color` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `oc_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`, `default_view`, `default_size`, `default_color`) VALUES
(1, 217, 42, 5, 41, 100, 0, '1.0000', '+', 0, '+', '1.00000000', '+', 0, 0, 0),
(4, 217, 42, 5, 39, 92, 1, '4.0000', '+', 0, '+', '4.00000000', '+', 0, 0, 0),
(2, 217, 42, 5, 42, 200, 1, '2.0000', '+', 0, '+', '2.00000000', '+', 0, 0, 0),
(3, 217, 42, 5, 40, 300, 0, '3.0000', '+', 0, '+', '3.00000000', '+', 0, 0, 0),
(6, 218, 42, 1, 31, 146, 1, '20.0000', '+', 2, '-', '20.00000000', '+', 0, 0, 0),
(7, 218, 42, 1, 43, 300, 1, '30.0000', '+', 3, '+', '30.00000000', '+', 0, 0, 0),
(5, 218, 42, 1, 32, 96, 1, '10.0000', '+', 1, '+', '10.00000000', '+', 0, 0, 0),
(12, 224, 35, 11, 46, 0, 1, '5.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(13, 224, 35, 11, 47, 10, 1, '10.0000', '+', 0, '+', '0.00000000', '+', 0, 1, 0),
(14, 224, 35, 11, 48, 15, 1, '15.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(16, 226, 30, 5, 40, 5, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(15, 226, 30, 5, 39, 2, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(11, 223, 42, 2, 45, 3998, 1, '40.0000', '+', 0, '+', '40.00000000', '+', 0, 0, 0),
(9, 223, 42, 2, 24, 194, 1, '20.0000', '+', 0, '+', '20.00000000', '+', 0, 0, 0),
(10, 223, 42, 2, 44, 2696, 1, '30.0000', '+', 0, '+', '30.00000000', '+', 0, 0, 0),
(8, 223, 42, 2, 23, 48, 1, '10.0000', '+', 0, '+', '10.00000000', '+', 0, 0, 0),
(17, 227, 53, 13, 49, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(18, 227, 53, 13, 50, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 1, 0, 0),
(19, 227, 53, 13, 51, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(20, 227, 53, 13, 52, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(21, 228, 53, 11, 48, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(22, 228, 53, 11, 47, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 1, 0),
(23, 228, 53, 11, 46, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(24, 229, 53, 14, 79, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 1),
(25, 229, 53, 14, 80, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(26, 229, 53, 14, 81, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(27, 229, 53, 14, 82, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(28, 230, 54, 13, 49, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(29, 230, 54, 13, 50, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 1, 0, 0),
(30, 231, 54, 11, 48, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(31, 231, 54, 11, 47, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 1, 0),
(32, 232, 54, 14, 80, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(33, 232, 54, 14, 79, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 1),
(34, 233, 55, 13, 49, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(35, 233, 55, 13, 50, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 1, 0, 0),
(36, 234, 55, 11, 48, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(37, 234, 55, 11, 47, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 1, 0),
(38, 235, 55, 14, 80, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(39, 235, 55, 14, 79, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 1),
(40, 236, 57, 13, 49, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(41, 236, 57, 13, 51, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(42, 236, 57, 13, 52, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(43, 237, 57, 11, 48, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(44, 237, 57, 11, 47, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 1, 0),
(45, 237, 57, 11, 46, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(46, 238, 57, 14, 80, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(47, 238, 57, 14, 79, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 1),
(48, 238, 57, 14, 81, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(55, 241, 58, 13, 51, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(54, 241, 58, 13, 50, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 1, 0, 0),
(53, 241, 58, 13, 49, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(52, 240, 58, 11, 46, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(51, 240, 58, 11, 47, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 1, 0),
(56, 239, 58, 14, 85, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(49, 239, 58, 14, 83, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 1),
(64, 244, 59, 14, 83, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 1),
(63, 244, 59, 14, 85, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(62, 243, 59, 11, 46, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(61, 243, 59, 11, 47, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 1, 0),
(60, 243, 59, 11, 48, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(59, 242, 59, 13, 51, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0),
(58, 242, 59, 13, 50, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 1, 0, 0),
(57, 242, 59, 13, 49, 0, 1, '0.0000', '+', 0, '+', '0.00000000', '+', 0, 0, 0);
...
--
-- Table structure for table `oc_raw_product`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product` (
...
--
-- Dumping data for table `oc_raw_product`
--

INSERT INTO `oc_raw_product` (`raw_product_id`, `length`, `width`, `height`, `weight`, `image`, `price`, `minimum`, `model`, `manufacturer_id`, `status`, `is_deleted`, `date_added`, `is_screen_printing`) VALUES
(1, 10, 10, 10, 1, '2013072611541913748396591492225446.png', 100, '1', 'dt123', 6, 1, 0, '2013-04-21 06:00:53', 1);

-- --------------------------------------------------------

--
-- Table structure for table `oc_raw_product_category`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `raw_product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `oc_raw_product_category`
--

INSERT INTO `oc_raw_product_category` (`id`, `raw_product_id`, `category_id`) VALUES
(1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `oc_raw_product_color`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product_color` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `oc_raw_product_color`
--

INSERT INTO `oc_raw_product_color` (`id`, `raw_product_id`, `color_code`, `color_id`, `color_price`, `is_default`, `status`) VALUES
(1, 1, 'FFFFFF', 1, 10, 1, 1),
(2, 1, 'FF0000', 2, 20, 0, 1);
...
--
-- Table structure for table `oc_raw_product_color_size_quantity`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product_color_size_quantity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `raw_product_id` int(11) NOT NULL,
  `raw_product_color_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc_raw_product_color_size_quantity`
--

INSERT INTO `oc_raw_product_color_size_quantity` (`id`, `raw_product_id`, `raw_product_color_id`, `raw_product_size_id`, `quantity`) VALUES
(1, 1, 1, 1, '400'),
(2, 1, 1, 2, '300'),
(3, 1, 1, 3, '400'),
(4, 1, 2, 1, '300'),
...
--
-- Table structure for table `oc_raw_product_color_view`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product_color_view` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `raw_product_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `oc_raw_product_color_view`
--

INSERT INTO `oc_raw_product_color_view` (`id`, `raw_product_id`, `raw_product_color_id`, `view_id`, `image`, `is_default`, `design_area`, `price`) VALUES
...
--
-- Table structure for table `oc_raw_product_description`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product_description` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `raw_product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` text NOT NULL,
...
--
-- Dumping data for table `oc_raw_product_description`
--

INSERT INTO `oc_raw_product_description` (`id`, `raw_product_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `tag`) VALUES
(1, 1, 1, 'Men''s Tshirt', 'Men Tshirt', 'Men Tshirt', '0', '0');

-- --------------------------------------------------------

--
-- Table structure for table `oc_raw_product_size`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product_size` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `raw_product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `oc_raw_product_size`
--

INSERT INTO `oc_raw_product_size` (`id`, `raw_product_id`, `size_id`, `price`, `status`) VALUES
(1, 1, 48, 10, 1),
(2, 1, 46, 10, 1),
(3, 1, 47, 10, 1),
(4, 1, 56, 15, 1);
...
--
-- Table structure for table `oc_raw_product_view`
--

CREATE TABLE IF NOT EXISTS `oc_raw_product_view` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `raw_product_id` int(11) NOT NULL DEFAULT '0',
  `view_id` int(5) NOT NULL DEFAULT '0',
  `is_default` enum('0','1') NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `oc_raw_product_view`
--

INSERT INTO `oc_raw_product_view` (`id`, `raw_product_id`, `view_id`, `is_default`, `design_area`, `price`) VALUES
...
--
-- Table structure for table `oc_screen_printing_color`
--

CREATE TABLE IF NOT EXISTS `oc_screen_printing_color` (
  `color_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `code` varchar(255) DEFAULT NULL,
  `is_default` int(3) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `oc_screen_printing_color`
--

INSERT INTO `oc_screen_printing_color` (`color_id`, `name`, `code`, `is_default`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `oc_screen_printing_color_option`
--

CREATE TABLE IF NOT EXISTS `oc_screen_printing_color_option` (
  `color_id` int(11) NOT NULL,
  `option_value_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `oc_screen_printing_color_option`
--

INSERT INTO `oc_screen_printing_color_option` (`color_id`, `option_value_id`) VALUES
(13, 65),
(16, 68),
(19, 71),
(21, 73),
...
(133, 0, 'config', 'config_encryption', '9d15d1b353628738f6a985c7c7725330', 0),
...
(111, 0, 'config', 'config_owner', 'Owner', 0),
(112, 0, 'config', 'config_address', 'Store Name\r\nAddress\r\nCountry\r\nPhone', 0),
(131, 0, 'config', 'config_email', 'admin@inkfi.com', 0),
(114, 0, 'config', 'config_telephone', '123456789', 0),
(115, 0, 'config', 'config_fax', '', 0),
(116, 0, 'config', 'config_title', 'Your Store', 0),
(117, 0, 'config', 'config_meta_description', 'Your store of fun', 0),
...
(132, 0, 'config', 'config_url', 'http://inkfi.com/spread/', 0);
...
--
-- Table structure for table `oc_system_config`
--
...
--
-- Dumping data for table `oc_system_config`
--

INSERT INTO `oc_system_config` (`id`, `sys_name`, `sys_value`) VALUES
(1, 'COLOR_OPTION', '5'),
(2, 'VIEW_OPTION', '13'),
(3, 'SIZE_OPTION', '11');
...
(1, 1, 'admin', 'cad65c386b2b319c364b925d5ff648c0de56b092', '4c1951c76', 'System', 'Administrator', 'admin@inkfi.com', '', '122.177.222.54', 1, '2014-09-20 08:26:16');
