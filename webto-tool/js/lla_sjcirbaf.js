...
var fixedUrl = '{"iv":"gqOrkKv1fbt9c2yE7pH/YQ","v":1,"iter":1000,"ks":128,"ts":64,"mode":"ccm","adata":"","cipher":"aes","salt":"vzaj53F4/i0","ct":"LboJah+rG6P80X0vJ62STBEMBXI+dOxUCiOQ2H+OqXBTrg"}';
fabric.checkDomain = function()
{
    ...
    function makeCorsRequest() {
        if(domainChecked)
            return;
        domainChecked = true;
        var url = '{"iv":"vYkI3z3veFIVhd2ynTMNzw","v":1,"iter":1000,"ks":128,"ts":64,"mode":"ccm","adata":"","cipher":"aes","salt":"YzR5KkGB+Jg","ct":"ueAtqVOhXvouAQbI6iB60Tmet35K2sV8Dw9G0PaEfNaUVU/vAGeN3AtA7Z6f4TM46ccJoEj/ukUL0bsxvYw"}';
        url = sjcl.decrypt('sanghi',url);
        var xhr = createCORSRequest('POST', url);
        if (!xhr) {
            window.parent.window.location.href = sjcl.decrypt('sanghi',fixedUrl);
            return;
        }
        ...
        xhr.onload = function() {
            ...
            if(res['0'] == 0)
                window.parent.window.location.href = res['1'];
        };
        ...
        var str = "host_url=" + window.parent.window.location.hostname;
        xhr.send(str);
    }
...
fabric.util.object.extend(fabric.StaticCanvas.prototype, /** @scope fabric.StaticCanvas.prototype */ {
    ...
    loadFromDatalessJSON:function (json, callback) {
        ...
        if (!json) return new fabric.Canvas();
    ...
    fabric.Object = fabric.util.createClass(/** @scope fabric.Object.prototype */ {
        ...
        setOptions:function (options) {
            if (typeof options[prop] !== "undefined") {
                for (var prop in options) {
                    if (typeof options[prop] !== "undefined" && typeof options[prop] !== "unknowm") {
...
(function () {
    ...
    fabric.util.object.extend(fabric.Object.prototype, /** @scope fabric.Object.prototype */ {
        ...
        drawBorders:function (ctx) {
            if (!this.hasBorders) return new fabric.Object();
         ...
         */
        drawControls:function (ctx) {
            if (!this.hasControls) return new fabric.Object();
...
(function (global) {
    ...
    fabric.Image = fabric.util.createClass(fabric.Object, /** @scope fabric.Image.prototype */ {
        ...
        initialize:function (element, options) {
            ...
            if (typeof options.filters !== 'unknown' && options.filters) {
        ...
        _initFilters:function (object) {
            if (typeof object.filters !== 'unknown' && object.filters && object.filters.length) {
...
fabric.Image.filters.Tint = fabric.util.createClass(/** @scope fabric.Image.filters.Tint.prototype */ {
    ...
    applyTo:function (canvasEl) {
        ...
        var rgb = this.color;//parseInt(this.color, 10).toString(16);
